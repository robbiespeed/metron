...
// import { insertNodes } from './element.js';
import { syncElementChildren } from './for.next.js';
...
// TODO: try putting all this stuff in a class so there is less arguments needed
// function appendIndexedNodes<TValue extends {}>(
//   indexedNodes: ChildNode[],
//   indexedDisposers: Disposer[][],
//   values: TValue[],
//   context: JSXContext,
//   createElement: TemplateComponent<TValue>,
//   start: number,
//   size: number
// ) {
...
//     // TODO: bench this, disposers is scoped, previously scoped variables negatively impact perf
//     indexedNodes[start] = createElement(values[start]!, context, (dispose) => {
...
function renderAtomArray<TValue extends {}>(
  ...
  register(syncElementChildren(parent, array, context, createElement, null));
  ...
  //   size
  // );
  // insertNodes(indexedNodes, i, size, parent, tail);
  ...
  //       size
  //     );
  //     insertNodes(indexedNodes, 0, size, parent!, tail);
  ...
  //           d();
  //         }
  //         const element = indexedNodes[start]!;
  ...
  //           disposers.push(dispose);
  //         });
  //         const prevElement = indexedNodes[start]!;
  ...
  //         indexedNodes[start] = bNode;
  //         indexedNodes[b] = aNode;
  ...
  //       size
  //     );
  //     insertNodes(indexedNodes, start, size, parent!, tail);
  //     return;
  //   }
